...
/// - Return raw provider model observations without catalog enrichment; throw when model listing is unavailable unless the provider owns an explicit static inventory.
